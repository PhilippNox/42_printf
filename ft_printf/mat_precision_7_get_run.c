...
/*   Updated: 2019/07/17 15:35:46 by wgorold          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_precision_longd(t_str_f *output, long double input)
{
	...
	power_tab[0] = tmp.t_parts_ld.exp ? (short)tmp.t_parts_ld.exp  - 16383 : STOP_SHORT;
...
void	get_precision_d(t_str_f *output, double input)
{
	...
	power_tab[0] = tmp.t_parts_d.exp ? (short)tmp.t_parts_d.exp  - 1023 : STOP_SHORT;
...
void	get_precision_f(t_str_f *output, float input)
{
	...
	power_tab[0] = tmp.t_parts_f.exp ? (short)tmp.t_parts_f.exp  - 127 : STOP_SHORT;
